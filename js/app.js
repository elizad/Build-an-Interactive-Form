...
////------------  T-SHIRT Section ---------------------/////
  ...
  $('#design').change(function(){
  	if ($('#design option:selected').val() === "js puns") {
  		$('#colors-js-puns').show();
  		$('#color').html('<option value="cornflowerblue"> Blue (JS shirt only)</option><option value="darkslategrey">Dark Grey (JS shirt only)</option><option value="gold">Gold (JS shirt only)</option>');
  		shirtSelected = true;
  		return shirtSelected;
  	} else if ($('#design option:selected').val() === "heart js") {
  		$('#colors-js-puns').show();
  		$('#color').html('<option value="darkslategrey">Dark Grey (I &#9829; to code)</option> <option value="gold">Gold ( Gold fish shirt)</option> <option value="tomato">Tomato (I &#9829; to code)<I &#9829; to code/option> <option value="steelblue">Steel Blue (I &#9829; to code)</option> <option value="dimgrey">Blue (I &#9829; to code)</option> ');
  		shirtSelected = true;
  		return shirtSelected;
  	} else {
  		$('#colors-js-puns').hide();
